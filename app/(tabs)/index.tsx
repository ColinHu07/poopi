...
export default function MapScreen() {
  ...
  return (
    <Screen
      ...
      title="Find your next great bathroom"
      right={
...
const styles = StyleSheet.create({
  ...
  loginButton: { minHeight: 42, borderRadius: 14, backgroundColor: palette.ink, paddingHorizontal: 15, alignItems: 'center', justifyContent: 'center' },
  loginButtonText: { color: palette.surface, fontSize: 13, fontWeight: '900' },
  searchRegion: { zIndex: 10 },
  searchBox: { minHeight: 60, borderRadius: 20, borderWidth: 1.5, borderColor: palette.cocoaSoft, backgroundColor: palette.surface, flexDirection: 'row', alignItems: 'center', gap: 8, paddingLeft: 16, paddingRight: 7, ...shadow },
  ...
  searchButton: { minWidth: 76, minHeight: 46, borderRadius: 15, paddingHorizontal: 13, backgroundColor: palette.jade, alignItems: 'center', justifyContent: 'center' },
  searchButtonText: { color: palette.surface, fontSize: 13, fontWeight: '900' },
  disabledButton: { opacity: 0.45 },
  searchResults: { position: 'absolute', top: 66, left: 0, right: 0, borderRadius: 20, borderWidth: 1.5, borderColor: palette.cocoaSoft, backgroundColor: palette.surface, overflow: 'hidden', ...shadow },
  ...
  advancedFilters: { borderRadius: 18, borderWidth: 1.5, borderColor: palette.cocoaSoft, backgroundColor: palette.surface, padding: 15, gap: 15 },
  filterGroup: { gap: 8 },
  ...
  locationPanel: { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 18, borderWidth: 1.5, borderColor: palette.cocoaSoft, backgroundColor: palette.goldSoft, padding: 14 },
  ...
  detailsButton: { minHeight: 42, borderRadius: 14, backgroundColor: palette.mint, paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center' },
  detailsButtonText: { color: palette.jade, fontSize: 13, fontWeight: '900' },
  ratePrompt: { borderRadius: 20, borderWidth: 1.5, borderColor: '#f3a391', backgroundColor: palette.coralSoft, padding: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 },
  ...
  rateButton: { minHeight: 46, borderRadius: 15, backgroundColor: palette.coral, paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center' },
  rateButtonText: { color: '#fffaf6', fontSize: 13, fontWeight: '900' },
  list: { gap: 10 },
  resultItem: { gap: 0 },
  resultRouteRow: { minHeight: 48, marginTop: -8, paddingTop: 7, borderWidth: 1.5, borderColor: palette.line, borderBottomLeftRadius: 18, borderBottomRightRadius: 18, backgroundColor: palette.surface, paddingLeft: 13, paddingRight: 8, flexDirection: 'row', alignItems: 'center', gap: 8 },
